...
# Multi-Company Incremental Sync for New Incremental Database
# This script runs incremental sync on the new incremental database

echo "Starting Multi-Company Incremental Sync for New Incremental Database..."
echo "====================================================================="

# Check if config file exists
if [ ! -f "config-multi-company-incremental-localdb.json" ]; then
    echo "Error: config-multi-company-incremental-localdb.json not found!"
...
node dist/index-multi-company.mjs --config config-multi-company-incremental-localdb.json
