-- Multi-Company Multi-Division Tally Database Structure - Simple Version
-- No primary keys on transaction tables - let application logic handle uniqueness
-- Data will be fetched based on (guid, company_id, division_id) combinations

-- Company and Division reference tables
...
(
 division_id varchar(36) not null primary key,
 company_id varchar(36) not null,
 division_name varchar(256) not null,
 tally_url varchar(512) not null,
 created_at timestamp default current_timestamp,
 updated_at timestamp default current_timestamp,
...
-- Temporary tables for incremental sync
create table _diff
(
...
-- Master data tables with company_id and division_id
...
-- Transaction tables with company_id and division_id
-- NO PRIMARY KEYS - Let application logic handle uniqueness
...
-- NO PRIMARY KEY - Allows multiple ledger entries per voucher
...
-- NO PRIMARY KEY - Allows multiple item entries per voucher
...
-- NO PRIMARY KEY - Allows multiple cost centre entries per voucher
...
-- NO PRIMARY KEY - Allows multiple cost category centre entries per voucher
...
-- NO PRIMARY KEY - Allows multiple cost inventory category centre entries per voucher
...
-- NO PRIMARY KEY - Allows multiple bill entries per voucher
...
-- NO PRIMARY KEY - Allows multiple bank entries per voucher
...
-- NO PRIMARY KEY - Allows multiple batch entries per voucher
...
-- NO PRIMARY KEY - Allows multiple inventory accounting entries per voucher
...
-- NO PRIMARY KEY - Allows multiple employee entries per voucher
...
-- NO PRIMARY KEY - Allows multiple payhead entries per voucher
...
-- NO PRIMARY KEY - Allows multiple attendance entries per voucher
...
create index idx_mst_group_company_division on mst_group(company_id, division_id);
create index idx_mst_ledger_company_division on mst_ledger(company_id, division_id);
create index idx_mst_vouchertype_company_division on mst_vouchertype(company_id, division_id);
create index idx_mst_stock_item_company_division on mst_stock_item(company_id, division_id);
create index idx_trn_voucher_company_division on trn_voucher(company_id, division_id);
create index idx_trn_voucher_date on trn_voucher(date);
create index idx_trn_accounting_company_division on trn_accounting(company_id, division_id);
create index idx_trn_inventory_company_division on trn_inventory(company_id, division_id);

-- Create composite indexes for efficient querying
create index idx_trn_voucher_guid_company_division on trn_voucher(guid, company_id, division_id);
create index idx_trn_accounting_guid_company_division on trn_accounting(guid, company_id, division_id);
create index idx_trn_inventory_guid_company_division on trn_inventory(guid, company_id, division_id);
create index idx_trn_cost_centre_guid_company_division on trn_cost_centre(guid, company_id, division_id);
create index idx_trn_bill_guid_company_division on trn_bill(guid, company_id, division_id);
create index idx_trn_bank_guid_company_division on trn_bank(guid, company_id, division_id);
create index idx_trn_batch_guid_company_division on trn_batch(guid, company_id, division_id);
